<x-app-layout>
 ...
 <section>
    <div class="container lg:px-20">
        <div class="block w-full pt-24 pb-18 px-4 lg:flex lg:flex-col lg:items-center ">
        ...
        <div class="px-4 w-full lg:pt-4 lg:pb-10">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <div class="flex justify-start mt-4">
                    <a href="{{ route('export_arsip', ['lembaga_id' => $arsip->lembaga_id]) }}" id="exportBtn" class="bg-green-500 hover:bg-green-700 text-white font-bold ml-4 py-2 px-4 rounded">Export</a>
